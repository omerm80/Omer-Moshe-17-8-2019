...
import * as fromWeatherData from '../store/weather.reducer';
import * as weatherDataAction from '../store/weather.actions';
@Component({
...
////////////////////////////
  onSelectionChanged(event: MatAutocompleteSelectedEvent) {// when the user picked a option from
   ...
   else
   {
    ...
    this.store.dispatch(new weatherDataAction.updateWeather(this.currWeather));
